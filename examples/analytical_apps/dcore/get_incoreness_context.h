...
#ifndef EXAMPLES_ANALYTICAL_APPS_GET_INCORENESS_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_GET_INCORENESS_CONTEXT_H_
...
class GetInCorenessContext : public VertexDataContext<FRAG_T, int> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit GetInCorenessContext(const FRAG_T& fragment)
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GET_INCORENESS_CONTEXT_H_