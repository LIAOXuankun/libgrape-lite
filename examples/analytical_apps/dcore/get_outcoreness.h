...
#ifndef EXAMPLES_ANALYTICAL_APPS_GET_OUTCORENESS_H_
#define EXAMPLES_ANALYTICAL_APPS_GET_OUTCORENESS_H_

#include <grape/grape.h>

#include "dcore/get_outcoreness_context.h"
...
class GetOutCoreness : public ParallelAppBase<FRAG_T, GetOutCorenessContext<FRAG_T>>,
public ParallelEngine {
public:
// specialize the templated worker.
INSTALL_PARALLEL_WORKER(GetOutCoreness<FRAG_T>, GetOutCorenessContext<FRAG_T>, FRAG_T)
...
#endif
  for(auto v: inner_vertices){
    messages.SendMsgThroughIEdges<fragment_t, int>(frag, v,
...
#endif  // EXAMPLES_ANALYTICAL_APPS_GET_OUTCORENESS_H_
