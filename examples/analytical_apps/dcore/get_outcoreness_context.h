...
#ifndef EXAMPLES_ANALYTICAL_APPS_GET_OUTCORENESS_CONTEXT_H_
#define EXAMPLES_ANALYTICAL_APPS_GET_OUTCORENESS_CONTEXT_H_
...
class GetOutCorenessContext : public VertexDataContext<FRAG_T, int> {
 public:
  using oid_t = typename FRAG_T::oid_t;
  using vid_t = typename FRAG_T::vid_t;

  explicit GetOutCorenessContext(const FRAG_T& fragment)
